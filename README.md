...
* **`popadanets_core_traits`**: A core set of significant character buffs.
    * Health: +8
    * Monthly Income: +35%
...
* **To manage `popadanets_core_traits`:**
    * To add the trait: `event popadanets_traits.0001`
...
* **`popadanets_core_traits`**: Основной набор значительных усилений персонажа.
    * Здоровье: +8
...
* **Для управления `popadanets_core_traits`**:
    * Чтобы добавить черту: `event popadanets_traits.0001`
